...
export const en: Catalog = {
  ...
  'menu.file.clone': 'Clone Bibliography…',
  ...
  'menu.publication.fromClipboard': 'New Publications from Clipboard',
  ...
  'prefs.abstractStorage': 'Abstract storage',
  'prefs.writeAbstractAs': 'Write abstracts as',
  'prefs.abstract.plain': 'Plain text (default, portable)',
  'prefs.abstract.readable': 'Readable (brace-safe)',
  'prefs.abstract.compressed': 'Compressed (safe, compact)',
  ...
  'prefs.ftsAtMost': 'At most',
  'prefs.ftsPages': 'pages',
  'prefs.ftsAll': 'All',
  ...
  'footer.importing': 'Looking up references…',
  'footer.imported': 'Imported: {parts}',
  'footer.importCreated': '{count} from identifier',
  'footer.importLinked': '{count} linked to existing',
  'footer.importReview': '{count} to review',
  'pdfReview.title': 'Review dropped PDFs',
  'pdfReview.heading': 'Review dropped PDFs ({count})',
  'pdfReview.hint':
    'These PDFs had no DOI or arXiv id, so no metadata could be fetched. Edit each entry on the right, then Accept to create it and attach the PDF — or Discard to skip it. Nothing is added to your library until you Accept.',
  ...
  'app.clipboardEmpty': 'The clipboard has no text to paste.',
  ...
  'fr.inGroup': ' — in {name}',
  'fr.filteredScope': ' (search filter active — {count} shown)',
  'fr.field': 'Field',
  ...
  'dialog.cloneFilesCopied': 'Copied {count} attachment {fileNoun} to {dir}',
  'dialog.cloneNoFiles': 'This bibliography links no files, so nothing was copied.',
  'dialog.cloneNoPapersFolder':
    'No AutoFile folder is set in Preferences, so the copies went into a folder beside the clone.',
  'dialog.cloneNotCopied':
    '{count} attachment(s) could not be copied. The clone still links the ORIGINAL files for these, so editing them there WILL affect your original library:',

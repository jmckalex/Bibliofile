...
// NB: the tabbed Annotation · Abstract · Attachments view ships as a built-in
// bottom-panel mode (the "Tabbed" option in the bottom-panel switch / View ▸
// Bottom Panel), not a preset — see DEFAULT_TABBED_BOTTOM_TEMPLATE. The tab and
// thumbnail conventions it relies on are documented for custom forks too.

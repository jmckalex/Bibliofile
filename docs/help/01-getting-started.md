...
Welcome to **bibdesk-electron**, a cross-platform bibliography manager for your
...
bibdesk-electron is a **BibTeX library manager**. You point it at a `.bib` file
...
Because the format is faithful, bibdesk-electron is designed to live *alongside*
your existing tools rather than to replace them. You can edit the same library
in BibDesk on a Mac and in bibdesk-electron on another machine, cite it from a
...
bibdesk-electron is a cross-platform Electron application. The core library code

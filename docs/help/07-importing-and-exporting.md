...
and the formats you can get back *out*. bibdesk-electron has grown a full set of
...
record on your clipboard. bibdesk-electron turns that clipboard text into a real
entry.
...
You can drop files straight onto the bibdesk-electron window. As soon as you drag
...
To get references *out* of bibdesk-electron in a different format, use the
